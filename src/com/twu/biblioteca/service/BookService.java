...
public class BookService {
    ...
    public Map<User, ArrayList<Book>> listBorrowBooks() {
        ...
        for (User user : borrowBooks.keySet()) {
            ArrayList<Book> books1 = borrowBooks.get(user);
            for (Book book : books1) {
                System.out.println("[userName:" + user.getName() + "---bookName:" + book.getName() + "]");
            }
        }
        return borrowBooks;
    }
    ...
    private void saveAsBorrow(User user, Book chooseBook) {
